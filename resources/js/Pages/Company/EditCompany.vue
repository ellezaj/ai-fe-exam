<script setup>
    ...
    const submit = () => {
        form.post(route('company.update',company), {
            onError: () => form.reset()
        });
    }
</script>
...
<template>
    <form @submit.prevent="submit">
            ...
            <div class="">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="col-span-full">
                        ...
                        <img :src="company.logo" alt="Company Logo" class="w-1/4">
                        <input id="logo-upload" name="logo-upload" type="file" class="" accept="image/png, image/jpeg, image/jpg" @input="change">
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button type="submit" class="btn warning-btn">Update</button>
        </div>
    </form>
